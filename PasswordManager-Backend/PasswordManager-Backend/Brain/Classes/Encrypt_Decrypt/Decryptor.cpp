...
const char* cDecryptor::DecryptString(const std::wstring input, unsigned long long key[], const unsigned long long encrypt_shift, const std::wstring pass_phrase)
{
